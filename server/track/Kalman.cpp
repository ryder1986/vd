...
TKalmanFilter::TKalmanFilter(Point_t pt, track_t dt, track_t Accel_noise_mag)
{
	...
	kalman->processNoiseCov = (cv::Mat_<track_t>(4, 4) <<
		pow(deltatime,(int)4.0)/4.0	,0						,pow(deltatime,(int)3.0)/2.0		,0,
		0						,pow(deltatime,(int)4.0)/4.0	,0							,pow(deltatime,(int)3.0)/2.0,
		pow(deltatime,(int)3.0)/2.0	,0						,pow(deltatime,(int)2.0)			,0,
		0						,pow(deltatime,(int)3.0)/2.0	,0							,pow(deltatime,(int)2.0));
